...
public class TelaFatorial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem/Capturar.PNG"))); // NOI18N
    ...
    private void txtNStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_txtNStateChanged
        ...
        int n = Integer.parseInt(txtN.getValue().toString());  // Captura o vaslor do botão giratório
        
        int f = 1;
        int c = n;
        
        /*
        * Formula de como fazer um fatorial:
        * 5! = 5 * 4 *3 * 2* 1 = 
        */
