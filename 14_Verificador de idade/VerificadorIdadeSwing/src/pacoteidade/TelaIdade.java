...
public class TelaIdade extends javax.swing.JFrame {
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
                                                         // Integer.parseInt() é para formatar para int a string do campo de texto
        int ano = Integer.parseInt(txtAno.getText());    // getText é para pegar o que o usuario escrever no campo de texto
        
        int idade = 2024 - ano;
        
        String sit = ((idade >= 16 && idade < 18) || (idade > 70)) ? "Voto opcional" : "Voto Obrigatório";
        
        lblIdade.setText(Integer.toString(idade));   // Aqui exibimos o variavel no label, o Integer.toString() é para converter int para string
        
        lblSituacao.setText(sit); // Como a variavel é String, não precisamos converter
